            ...
            <Fragment>
                <nav>
                    <div className="logobtn">
                        ...
                        <div className="mob">
                        <img src={theme === 'light' ? moon : sun}  onClick={toggleTheme} alt="toggle" className="sun-moon-1"/>      
                    ...
                    <ul className={this.state.isOpen ? 'showNav':'undefined'} data-testid="navbar">
                        ...
                        <img src={theme === 'light' ? moon : sun}  onClick={toggleTheme} alt="toggle" className="sun-moon-2"/>      
                    </ul>
